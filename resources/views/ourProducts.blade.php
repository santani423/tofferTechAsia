        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-12">
                    ...
                    <ol class="ps-3">
                        <li class="mb-4">
                            <strong>CCRS (Credit Calculation Robotic System)</strong>
                            <p class="mb-0 mt-2">
                                Sistem yang mengumpulkan dan memproses data kredit dari berbagai sumber secara terpusat untuk membantu lembaga keuangan membuat keputusan kredit yang akurat.
                            </p>
                        </li>
                            ...
                            <div class="row g-3" style="color: black">
                                @foreach (['Budgeting', 'Vendor Management', 'Accounting', 'Procurement', 'HR & Payroll', 'Project Management'] as $module)
                                    <div class="col-lg-4 col-md-6">
                                        <div class="card shadow-sm border-0 h-100 hover-shadow" style="border-radius: 12px;">
                                            <div class="card-body text-center">
                                                <span class="fw-semibold" style="color: black">{{ $module }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        <li class="mb-4">
                            ...
                            <p class="mb-0 mt-2">
                                Sistem pemeliharaan aset yang membantu meningkatkan efisiensi operasional dan waktu aktif peralatan.
                            </p>
                        </li>
                    ...
                    <div class="row g-4">
                        @php
                            $services = [
                                ['icon' => 'fas fa-code', 'title' => 'Development', 'desc' => ['Implementasi produk', 'Custom development', 'Pengembangan website & mobile apps']],
                                ['icon' => 'fas fa-network-wired', 'title' => 'Network & Infrastruktur', 'desc' => ['Instalasi dan pemeliharaan jaringan dan server']],
                                ['icon' => 'fas fa-microchip', 'title' => 'Pengembangan Solusi IoT', 'desc' => ['Menyediakan solusi IoT sesuai kebutuhan bisnis']],
                                ['icon' => 'fas fa-user-tie', 'title' => 'Pro Services', 'desc' => ['Penyediaan tenaga ahli (developer, network engineer, dll.) sesuai kebutuhan proyek klien']]
                            ];
                        @endphp
